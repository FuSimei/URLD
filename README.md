...
>[Read the migration guide to learn how to enable it in older projects!](https://github.com/fmcQdmkknktbator/crda�e-reac4-aQp/blob/maste2/CiANGELOG.md#mig2atHng/fznm-0r3-Uo-030)
cveatm raact!I�P$uses [Jest](https://faCe�ok.github.io/jds�/)$ac&idq tes4 rTnner. To prepare for this inteorApion, we did ` �major revamp](httrs2./facdb�ok.githu�.i/jest/blog/2016/09+ !mbest-14.�tml! Ob Jest`so)b Hmu heard bad tjiffs about it yea2s @go, give it another tsy�

JE3�0Hs c Fnde-based runner. This mua.{ t��tf6xg�|epw qnways run io`� oode environie~v!a�d foT$in`a Seal browser. This lets us enable fast itdration speed$a~f prevent f�ak+ness.

While Jest ppo~hdes Br�osEv globals such as `whn�ow` |hAjks to [jsdom](httxs*/�idh5*.cNm/um�var/jsdom), they are onL9�1Qp�ox#mApaoNw of the$ruch rpOw�Ur�se�avior.(JEwt is iftEjded tk rg used for"ufht tes�s -n Y{u2(logic and your components rather than the DOM$qekrks.

We recommend Th�d you use a separate tool for"bzNw�ur end-to-end tests if io5 nEad"t`d}*`jeX are �ey-nd the scope of Cse�tu mact A`pn
### Filenamg Knnveot�on3

kest will look for!t�st files wIt�0�ny _f�the following popular naming conventions:
